...
## نسخه 1.2.2 — Integration Core Final

- دریافت پیام‌های تلگرام به حالت پایدار Polling تغییر کرده و Webhook قدیمی در شروع حذف می‌شود.
- فاکتور دستی، API فروشگاه‌ها، Callback امضاشده، تأیید پیامک، کارت مقصد، کیف پول و گزارش‌ها فعال‌اند.
- مرکز آپشن‌ها، اتوماسیون فروش، محصول، اشتراک، تخفیف، صندوق و قابلیت‌های فروشگاه‌ساز در Runtime و منو غیرفعال‌اند.
- جدول‌های قدیمی فقط برای حفظ سازگاری و جلوگیری از حذف اطلاعات باقی مانده‌اند.
