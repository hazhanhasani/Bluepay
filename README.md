...
- تشخیص قالب واقعی بلوبانک با عبارت «به حساب شما نشست»
- بازیابی متن پیامک از JSON تو در تو، فیلدهای ناشناخته، متن URL-encoded و قالب `From:`
- امکان پردازش پیامک حتی اگر فیلد جداگانه sender ارسال نشده باشد ولی متن بانک معتبر باشد
- نمایش نسخه پردازشگر و بخشی از متن واقعی دریافت‌شده در اعلان خطا
- افزودن نسخه و preview به پاسخ Webhook برای عیب‌یابی دقیق
