...
برای هر فاکتور جدید، سیستم به مبلغ اسمی یک عدد خودکار بین ۱ تا ۹۹۹ تومان اضافه می‌کند.
این عدد در `unique_amount_rial` ذخیره می‌شود و مبلغی که مشتری باید دقیقاً واریز کند در
`payable_amount_rial` قرار دارد. رزرو مبلغ در سطح دیتابیس انجام می‌شود تا دو فاکتور فعال
روی یک کارت مقصد، حتی در درخواست‌های هم‌زمان، مبلغ نهایی یکسان نگیرند.
