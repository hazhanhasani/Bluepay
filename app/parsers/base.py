...
class BankSmsParser:
    ...
    credit_words = (
        ...
        "به حساب شما نشست", "به حسابتان نشست", "به حساب شما واریز شد",
        "به حساب شما واريز شد", "به حساب نشست",
    )
    debit_words = (
    ...
    def extract_amount(text: str) -> tuple[int | None, int]:
        ...
        patterns = [
            r"([0-9][0-9,\. ]{3,})\s*(ریال|ريال|تومان)\s*(?:به\s+حساب(?:\s+شما|تان)?\s+(?:نشست|واریز\s+شد|واريز\s+شد))",
